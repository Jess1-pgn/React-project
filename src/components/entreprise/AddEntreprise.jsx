...
const AddEntreprise = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Erreur lors de l\'ajout de l\'entreprise');
  ...
  return (
    <div className="add-entreprise-container">
      <div className="form-header">
        ...
        <p>Remplissez les informations de l'entreprise</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="entreprise-form">
        ...
        <div className="form-actions">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? 'En cours...' : 'Ajouter l\'entreprise'}
          </button>
        </div>
      </form>
    </div>
